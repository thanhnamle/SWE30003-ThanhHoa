  ...
  return (
    <div className="min-h-screen w-full flex bg-slate-50">
      <style>{`
        ...
        @keyframes sfm-pop { from { opacity: 0; transform: scale(0.85); } to { opacity: 1; transform: scale(1); } }
        ...
        .sfm-pin { animation: sfm-pin-pulse 2.2s ease-in-out infinite; }
        .sfm-pin:nth-child(2) { animation-delay: 0.6s; }
        .sfm-pin:nth-child(3) { animation-delay: 1.2s; }
        .sfm-enter { opacity: 0; animation: sfm-fade-up 0.55s ease-out forwards; }
        .sfm-shake { animation: sfm-shake 0.4s ease-in-out; }
        .sfm-glow-orb { animation: sfm-float 7s ease-in-out infinite; }
        .sfm-pop { animation: sfm-pop 0.25s ease-out; }
        @media (prefers-reduced-motion: reduce) {
          .sfm-panel-bg, .sfm-route-path, .sfm-truck, .sfm-pin, .sfm-enter, .sfm-shake, .sfm-glow-orb, .sfm-pop {
      ...
      {/* Form panel */}
      <div className="flex-1 flex items-center justify-center p-4 py-10 relative">
        <div
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  ...
                  />
                  {passwordsMatch && (
                    <CheckCircle2 className="absolute right-3.5 top-3.5 w-4 h-4 text-emerald-500 sfm-pop" />
                  )}
                </div>
